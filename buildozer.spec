...
title = SnapCategorizer

# (str) Package name
package.name = snapcategorizer

# (str) Package domain (needed for android/ios packaging)
package.domain = com.yh_nr
...
requirements = Python3, kivy==2.2.0, cython, japanize_kivy, plyer, pyjnius, numpy, camera4kivy, gestures4kivy
